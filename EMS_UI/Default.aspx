...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:HyperLink ID="HyperLinkListEmp" runat="server" NavigateUrl="~/ListEmployees.aspx">Employee List</asp:HyperLink>
        <br />
        ...
        <br />
        <asp:HyperLink ID="HyperLinkEmpByDept" runat="server" NavigateUrl="~/EmployeesByDepartment.aspx">Employees by Dept</asp:HyperLink>
    </div>
</asp:Content>
